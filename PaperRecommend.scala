...
/**
  * Created by mxs15 on 5/4/2017.
  */
object PaperRecommend {
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("F:\\Projecttttttttttttttt\\out.dblp-author")
    ...
    println("Papers recommended for author with id 2, format(authorid, recommend authorid, likelihood):")
